...
//photoItemCollectionViewCell

class PhotoGalleryTableViewCell: UITableViewCell {

    @IBOutlet weak var outerView: UIView!
    @IBOutlet weak var labelPhotoGallery: UILabel!
    ...
    func registerCell(){
        photoGalleryCollectionView.register(UINib.init(nibName: "PhotoItemGalleryCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "photoItemCollectionViewCell")
...
extension PhotoGalleryTableViewCell : UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let item = collectionView.dequeueReusableCell(withReuseIdentifier: "photoItemCollectionViewCell", for: indexPath) as! PhotoItemGalleryCollectionViewCell
